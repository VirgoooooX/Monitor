// Xiaomi (Mimo) provider adapter — Foundation Phase placeholder (health_only).
//
// Xiaomi's Mimo API has no public quota endpoint; the v1.1 adapter will
// perform a lightweight reachability + auth check against the Mimo REST
// endpoint and emit a `kind: 'health'` snapshot. v1 returns the
